...
-define(LOG(Level,Msg),
        ec_genet_logger:log(Level, ?MODULE, ?LINE,
                                    ["LOG ~s", [Msg]])).
...
-define(LOGMSG(Msg), ?LOG(trace, Msg)).
-define(LOGMSG(Msg, Arg1), ?LOG(trace, Msg, Arg1)).
-define(LOGMSG(Msg, Arg1, Arg2), ?LOG(trace, Msg, Arg1, Arg2)).
-define(LOGMSG(Msg, Arg1, Arg2, Arg3), ?LOG(trace, Msg, Arg1, Arg2, Arg3)).
-define(LOGMSG(Msg, Arg1, Arg2, Arg3, Arg4), ?LOG(trace, Msg, Arg1, Arg2, Arg3, Arg4)).
-define(LOGMSG(Msg, Arg1, Arg2, Arg3, Arg4, Arg5), ?LOG(trace, Msg, Arg1, Arg2, Arg3, Arg4, Arg5)).
-define(LOGMSG(Msg, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6), ?LOG(trace, Msg, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6)).
